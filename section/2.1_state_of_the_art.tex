% The TEM method was introduced in the late 1960s and 
...
and detect geological structures such as faults, fractures, and aquifers~\parencite{christiansen2006tem}.
...
using various geophysical methods~\parencite{gomez2019alluvial, galazoulas2015petrophysical, george2021petrophysical}.
...
As a result, noise introduces variability, making it impossible to find a unique solution~\parencite{zhdanov2002inversion}.
...
Particle swarm optimization (PSO) and Bayesian inversion are examples of stochastic methods~\parencite{rucker2017pygimli, xue2020inversion}.
...
The L-curve method is widely used to determine the optimal $\lambda$ for the solution of an inverse problem~\parencite{hansen1992lcurve}.
...
\textcite{lloyd1997lcurve} implements a method to find the point of maximum curvature and through this the optimal $\lambda$ for the inversion of diffusion battery data.
...
A similar approach was used by \textcite{farquharson2004lcurve} to find the optimal $\lambda$.
...
Another approach for finding the optimal $\lambda$ is the iterative golden section search as proposed by \textcite{cultrera2020lcurve}.

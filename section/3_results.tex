...
\begin{table}[!ht]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{ccc}
            \toprule
            \textbf{Search Type} & \textbf{Successrate (\%)} & \textbf{Mean relative deviation (\%)}\\
            \midrule
            \textbf{22nd May 2024} \\
            Visual & 83.33 & - \\
...
A consistant trend throughout our analysis of the search algorithms (\cref{tab:search-summary})
is that the second survey performed better for the L-Curve method, than the first survey.
...
the values in \cref{tab:resistivity}.

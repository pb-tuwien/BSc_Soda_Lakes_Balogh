...
as decribed by \textcite{aigner2021flexible} influence the measurents until about $8\,\mu\text{s}$, 
which alignes with the $4.2-8.6\,\mu\text{s}$, found by \textcite{aigner2021flexible}.
...
which should be a bit smaller for smaller loop sizes~\parencite{aigner2021flexible}.
The long lasting effect of the turn-off ramp for the soundings in the water, 
can on one side be attributed to a longer turn-off ramp in water~\parencite{aigner2021flexible} and can
...
The inversion algorithm~\parencite{aigner2021flexible} used for the inversion needs various starting parameters.
...
\textcite{welkens2025seewinkel} shows that model with $1\,\text{m}$-Layers until $5\,\text{m}$ depth 
...
Regarding the noise floor, the minimum value for the relative error used in the inversion, \textcite{aigner2024sensitivity}
...
measurement configuration resembles the configuration with the smaller loop by \textcite{aigner2024sensitivity}.
...
This range covers the lambda values \textcite{aigner2024sensitivity} used for the inversion 
...
described by \textcite{hansen1992lcurve,farquharson2004lcurve}, but TEM data
...
and thus being discarded in the first iteration of the search algorithm. \textcite{cultrera2020lcurve} described 
...
and thus a new layer~\parencite{fitterman1986transient}, but it could also be data noise.
...
to discern the same three layers regarding the thicknesses, which \textcite{aigner2024sensitivity} found
in a borehole at the soda lakes, which is located about $1.5\,\text{km}$ north-east of the Martenhofer Lacke.
\textcite{aigner2024sensitivity} describes a $1.6\,\text{m}$ clay-silt layer, 
...
This agrees well with the borehole data described by \textcite{aigner2024sensitivity}.
The third layer with the resistivity of $22\,\Omega\text{m}$ and $30\,\Omega\text{m}$ respectively, 
could indicate a second aquifer, which was also detected by \textcite{aigner2024sensitivity}, who found
...
is counteracted by the effects of turn-off ramp as described by \textcite{aigner2021flexible} and thus the need to discard the early time data.
...
\textcite{aigner2024sensitivity} the best out of the configurations tested in this work.
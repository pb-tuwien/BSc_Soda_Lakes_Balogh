...
\textcite{Welkens2025} shows that model with $1\,\text{m}$-Layers until $5\,\text{m}$ depth 
...
described by \textcite{hansen1999curve,farquharson2004comparison}, but TEM data
...
and thus being discarded in the first iteration of the search algorithm. \textcite{cultrera2020simple} described 

...
To properly interpret TEM data, inversion algorithms are applied and 
...
to the inversion of TEM data, as well as comparing three different search algorithms for 
the automatic interpretation of the L-Curve.
In particular, we test the L-Curve method on TEM data collected at the 
...
we were able to resolve the shallowest three layers using a single square loop with the side lenght of $12.5\,\text{m}$ 
and a current of $4.1\,\text{A}$. 
We found an aquifer between the depths of $4-10.5\,\text{m}$ with a resistivity of $30\,\Omega\text{m}$,

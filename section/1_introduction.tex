...
\begin{itemize}
    ...
    \item Which automated search algorithms can be implemented to find an optimal lambda?
    \item Which conditions are necessary for the for an automatic determination of the lambda value?
\end{itemize}
...
applications like groundwater detection~\parencite{aigner2024sensitivity}. % TODO: check if good source

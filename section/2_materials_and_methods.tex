...
While they provide a general reference, it is important to note that resistivity ranges can vary significantly due to factors such as moisture content, salinity, porosity, and mineral composition.
...
There are several methods to solve an inverse problem, but the most common approach is to use Tikhonov regularization\ref{eq:tikhonov}.

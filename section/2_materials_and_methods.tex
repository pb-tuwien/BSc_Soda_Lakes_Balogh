...
infered through the apparent resistivities in (c), which makes the interpretation of the data necessary~\parencite{fittermanTransientElectromagneticSounding1986,christiansenTransientElectromagneticMethod2006}.
...
as most inversion algorithms work with a one dimensional model, the subsurface is assumed to be homogeneous in the horizontal direction~\parencite{christiansenTransientElectromagneticMethod2006}.
...
which reduces noise in the gathered data to a minimum~\parencite{aignerSensitivityAnalysisInverted2024}.

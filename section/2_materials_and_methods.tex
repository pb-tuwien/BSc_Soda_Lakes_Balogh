...
\begin{table*}[!ht]
    \centering
    \caption{Parameters relating to the time-key of the TEM-FAST 48 HPC system (Excerpt from the manual).}
    \begin{tabular}{cccc}
        \hline
...
\begin{table*}[h]
    \centering
    \caption{Device settings used as well as the resulting measured time ranges and total number of pulses stacked for each sounding of both surveys.}
...
In case of particularly noisy data it is possible to set a minimum value for the relative error.

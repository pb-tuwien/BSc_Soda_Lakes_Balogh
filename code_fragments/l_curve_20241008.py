...
from pathlib import Path
from code_fragments.filtering_20241008 import tem_data, tem_coords, rename_points_1008, parsing_coords_1008, erroneous_soundings_1008

#%%

optimal_lambda = 234 # Visual Inspection
